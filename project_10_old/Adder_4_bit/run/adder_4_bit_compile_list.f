-i ../verif/env 
-i ../verif/env/agents 
-i ../verif/env/agents/adder_4_bit_agent
-i ../verif/env/register
-i ../verif/env/ref_model
-i ../verif/env/top
-i ../verif/tests 
-i ../verif/tests/sequence_lib/
-i ../verif/tests/sequence_lib/src/
-i ../verif/tests/src 
-i ../verif/tb/src  
../src/design/half_adder.sv
../src/design/full_adder.sv
../src/design/adder_8_bit.sv
